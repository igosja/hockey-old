...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
        <h3 class="page-header">Логотипы команд</h3>
    </div>
</div>
<form>
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive">
            ...
            <table class="table table-striped table-bordered table-hover table-condensed">
                ...
                <tr id="filters">
                    <td>
                        <label class="hidden" for="logo_id"></label>
                        <input
                            class="form-control"
                            id="logo_id"
                            name="filter[logo_id]"
                            value="<?= f_igosja_request_get('filter', 'logo_id'); ?>"
                        />
                    </td>
                    <td></td>
                    <td>
                ...
                <?php foreach ($logo_array as $item) { ?>
                    <tr>
                        <td class="text-center"><?= $item['logo_id']; ?></td>
                        <td><?= f_igosja_ufu_date_time($item['logo_date']); ?></td>
                        <td>
                        ...
                        <td class="text-center">
                            <a href="/admin/logo_view.php?num=<?= $item['logo_id']; ?>" class="no-underline">
                                <i class="fa fa-eye fa-fw"></i>
                            </a>
                            <a href="/admin/logo_delete.php?num=<?= $item['logo_id']; ?>" class="no-underline">
