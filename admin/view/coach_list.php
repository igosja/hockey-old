...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
        <h3 class="page-header">Теренеры сборных</h3>
    </div>
</div>
<form>
    <div class="row">
            ...
            <table class="table table-striped table-bordered table-hover table-condensed">
                ...
                <?php foreach ($user_array as $item) { ?>
                    <tr>
                        ...
                        <td>
                            <?= $item['coach_country_name']; ?>
                            <?= $item['vice_country_name']; ?>
                            (<?= $item['coach_nationaltype_name']; ?><?= $item['vice_nationaltype_name']; ?>,
                            <?php if ($item['coach_nationaltype_name']) { ?>тренер<?php } else { ?>заместитель<?php } ?>)
                        </td>
