...
{
    $auth_national_id = $auth_nationalvice_id;
}

$sql = "SELECT `game_guest_national_id`,
               IF(`game_home_national_id`=$auth_national_id, `game_home_lineup_user_id`, `game_guest_lineup_user_id`) AS `game_lineup_user_id`,
               IF(`game_home_national_id`=$auth_national_id, IF(`game_home_mood_id`, `game_home_mood_id`, " . MOOD_NORMAL . "), IF(`game_guest_mood_id`, `game_guest_mood_id`, " . MOOD_NORMAL . ")) AS `game_mood_id`,
               IF(`game_home_national_id`=$auth_national_id, `game_home_rude_1_id`, `game_guest_rude_1_id`) AS `game_rude_1_id`,
               IF(`game_home_national_id`=$auth_national_id, `game_home_rude_2_id`, `game_guest_rude_2_id`) AS `game_rude_2_id`,
               IF(`game_home_national_id`=$auth_national_id, `game_home_rude_3_id`, `game_guest_rude_3_id`) AS `game_rude_3_id`,
               IF(`game_home_national_id`=$auth_national_id, `game_home_style_1_id`, `game_guest_style_1_id`) AS `game_style_1_id`,
               IF(`game_home_national_id`=$auth_national_id, `game_home_style_2_id`, `game_guest_style_2_id`) AS `game_style_2_id`,
               IF(`game_home_national_id`=$auth_national_id, `game_home_style_3_id`, `game_guest_style_3_id`) AS `game_style_3_id`,
               IF(`game_home_national_id`=$auth_national_id, IF(`game_home_tactic_1_id`, `game_home_tactic_1_id`, " . TACTIC_NORMAL . "), IF(`game_guest_tactic_1_id`, `game_guest_tactic_1_id`, " . TACTIC_NORMAL . ")) AS `game_tactic_1_id`,
               IF(`game_home_national_id`=$auth_national_id, IF(`game_home_tactic_2_id`, `game_home_tactic_2_id`, " . TACTIC_NORMAL . "), IF(`game_guest_tactic_2_id`, `game_guest_tactic_2_id`, " . TACTIC_NORMAL . ")) AS `game_tactic_2_id`,
               IF(`game_home_national_id`=$auth_national_id, IF(`game_home_tactic_3_id`, `game_home_tactic_3_id`, " . TACTIC_NORMAL . "), IF(`game_guest_tactic_3_id`, `game_guest_tactic_3_id`, " . TACTIC_NORMAL . ")) AS `game_tactic_3_id`,
               `game_ticket`,
...
if ($auth_national_id == $auth_nationalvice_id && !in_array($current_array[0]['game_lineup_user_id'], array(0, $auth_user_id)))
{
    $allow_post = false;
...
if (($data = f_igosja_request_post('data')) && $allow_post)
{
    ...
    if ((MOOD_SUPER == $mood_id && $nationalmood_array[0]['national_mood_super'] <= 0) || (MOOD_REST == $mood_id && $nationalmood_array[0]['national_mood_rest'] <= 0) || (MOOD_NORMAL != $mood_id && TOURNAMENTTYPE_FRIENDLY == $current_array[0]['schedule_tournamenttype_id']))
    {
        $mood_id = MOOD_NORMAL;
    }
    ...
    $sql = "UPDATE `game`
            SET `game_home_lineup_user_id`=$auth_user_id,
                ...
                `game_ticket`=$ticket
            WHERE `game_home_national_id`=$auth_national_id
            AND `game_id`=$num_get
            LIMIT 1";
    f_igosja_mysqli_query($sql);

    $sql = "UPDATE `game`
            SET `game_guest_lineup_user_id`=$auth_user_id,
    ...
    for ($i=0; $i<16; $i++)
    {
        ...
        $sql = "SELECT `lineup_id`
                ...
                AND `lineup_national_id`=$auth_national_id
                LIMIT 1";
        ...
        if (0 == $lineup_sql->num_rows)
        {
            $sql = "INSERT INTO `lineup`
                    SET `lineup_game_id`=$num_get,
                        ...
                        `lineup_national_id`=$auth_national_id";
            f_igosja_mysqli_query($sql);
        }
        else
        {
...
$sql = "SELECT `game_id`,
               IF(`game_guest_national_id`=$auth_national_id, `game_guest_tactic_1_id`, `game_home_tactic_1_id`) AS `game_tactic_id`,
               IF(`game_guest_national_id`=$auth_national_id, 'Г', 'Д') AS `home_guest`,
               `schedule_date`,
               `stage_name`,
               `national_id`,
        ...
        LEFT JOIN `national`
        ON IF(`game_guest_national_id`=$auth_national_id, `game_home_national_id`, `game_guest_national_id`)=`national_id`
        LEFT JOIN `country`
