...
$sql = "SELECT `guest_city`.`city_name` AS `guest_city_name`,
               ...
               `guest_national`.`national_visitor` AS `guest_team_visitor`,
               ...
               `home_national`.`national_visitor` AS `home_team_visitor`,
               `home_team`.`team_id` AS `home_team_id`,
               `home_team`.`team_name` AS `home_team_name`,
               IFNULL(`playerspecial_level`, 0) AS `playerspecial_level`,
               `schedule_date`,
               `schedule_season_id`,
               `game_stadium`.`stadium_capacity` AS `stadium_capacity`,
               `game_stadium`.`stadium_name` AS `stadium_name`,
               `stage_name`,
               `stage_visitor`,
               `tournamenttype_id`,
               `tournamenttype_name`,
        ...
        LEFT JOIN `stadium` AS `game_stadium`
        ON `home_national`.`national_stadium_id`=`game_stadium`.`stadium_id`
        LEFT JOIN
        (
