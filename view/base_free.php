...
<?php if (isset($base_accept)) { ?>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
            <a href="/base_free.php?building_id=<?= $building_id; ?>&constructiontype_id=<?= $constructiontype_id; ?>&ok=1" class="btn margin">Строить</a>
            <a href="/base_free.php" class="btn margin">Отказаться</a>
        </div>
    </div>
<?php } else { ?>
    <div class="row margin-top">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
            ...
            <span class="strong"><?= $base_array[0]['team_free_base']; ?></span>
        </div>
    </div>
    <div class="row margin-top">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
